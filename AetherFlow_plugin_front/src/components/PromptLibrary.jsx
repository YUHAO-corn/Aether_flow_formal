      ...
      <div className="flex items-center justify-between mb-4 relative z-40">
        <div className="relative flex-1 mr-4">
          <input
            ...
            className="w-full bg-gray-800/50 border border-gray-700 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-transparent"
            value={searchTerm}
